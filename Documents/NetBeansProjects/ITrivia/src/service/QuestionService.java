    ...
    public List<Question> getQuestions(String difficulty) {
        ...
        if (difficulty.equalsIgnoreCase("Easy")) {
            questions.add(new Question("What programming language is named after a type of Indonesian coffee?",
                    new String[]{"Java", "Python", "Ruby", "Swift"}, 0));
            ...
            questions.add(new Question("What file extension is used for Java source code files?",
                    new String[]{".java", ".js", ".class", ".jav"}, 0));

            questions.add(new Question("What does \"IDE\" stand for in software development?",
                    new String[]{"Integrated Development Environment", "Integrated Debug Environment", "Internal Design Editor", "Interface Design Engine"}, 0));

            questions.add(new Question("Who is known as the first computer programmer?",
                    new String[]{"Ada Lovelace", "Charles Babbage", "Alan Turing", "Grace Hopper"}, 0));

            questions.add(new Question("What was the first computer virus called?",
                    new String[]{"Creeper", "ILOVEYOU", "Brain", "Slammer"}, 0));
            ...
            questions.add(new Question("What do you call the brain of the computer?",
                    new String[]{"CPU (Central Processing Unit)", "GPU", "RAM", "ROM"}, 0));

            questions.add(new Question("What does HTML stand for?",
                    new String[]{"HyperText Markup Language", "HyperText Markup Level", "Hyper Transfer Markup Language", "Hyper Tool Mark Language"}, 0));

            questions.add(new Question("What company owns the Java trademark today?",
                    new String[]{"Oracle Corporation", "Microsoft", "Google", "Sun Microsystems"}, 0));

            questions.add(new Question("What do you use to move the pointer on the screen?",
                    new String[]{"Mouse", "Keyboard", "Scanner", "Monitor"}, 0));

            questions.add(new Question("What part of the computer lets you see what you're doing?",
                    new String[]{"Monitor", "CPU", "Printer", "Speaker"}, 0));

            questions.add(new Question("Which company developed the Java programming language?",
                    new String[]{"Sun Microsystems", "Oracle", "Microsoft", "IBM"}, 0));

            questions.add(new Question("What are the two most commonly used tools for planning a program's logic?",
                    new String[]{"Flowchart and Pseudocode", "Diagram and Flowcode", "Blueprint and Syntax", "Model and Algorithm"}, 0));
            ...
            questions.add(new Question("A method that doesn't return any value",
                    new String[]{"Void", "Returnless", "Empty", "Null"}, 0));
            ...
            questions.add(new Question("An abstract class has both what?",
                    new String[]{"A regular method and an abstract method", "Only static methods and constructors", "Private methods and interfaces", "Constructors and final methods"}, 0));

            questions.add(new Question("Once an abstract method is declared in the super class, it is what?",
                    new String[]{"It is mandatory for all subclasses", "Optional to override in the subclass", "Automatically implemented in all subclasses", "Converted into a static method in subclasses"}, 0));

            questions.add(new Question("What is an Abstract method?",
                    new String[]{"A method that doesn't have a body", "A method that can only be called from a constructor", "A method that is always static and final", "A method that automatically executes at runtime without being called"}, 0));
            ...
            questions.add(new Question("In a complex system using hybrid inheritance via interface in Java, how can class D correctly inherit from interface A and both classes B and C if C and B implement different interfaces extending A?",
                    new String[]{"By defining D to implement a new interface that extends both interfaces implemented by B and C", "By making D extends both B and C directly, since Java supports multiple class inheritance through interfaces", "By using abstract classes instead of interfaces since Java handles hybrid inheritance via abstract classes", "By forcing B and C to share a common superclass and extending only one of them in D"}, 0));
            ...
            questions.add(new Question("What is the primary benefit of polymorphism in object-oriented programming?",
                    new String[]{"Enables one interface to be used for a general class of actions", "Allows hiding of data", "Enables code reuse through copying", "Prevents the use of constructors in derived classes"}, 0));
            ...
            questions.add(new Question("Which of the following is true about Java interfaces?",
                    new String[]{"They can only contain abstract methods and static final variables", "They can have constructors", "They can contain instance fields", "They can be instantiated directly"}, 0));
            ...
            questions.add(new Question("What happens if a Java class implements multiple interfaces that have methods with the same signature?",
                    new String[]{"The class must override the method once", "It causes a compilation error", "The first interface's method is chosen", "Java does not support multiple interfaces"}, 0));
            ...
            questions.add(new Question("Which exception must be either caught or declared to be thrown in Java?",
                    new String[]{"Checked exceptions", "Runtime exceptions", "Errors", "All exceptions"}, 0));
            ...
            questions.add(new Question("What is the output of the following code?\nint x = 10;\nSystem.out.println(x++);",
                    new String[]{"10", "11", "Compilation error", "Runtime exception"}, 0));

            questions.add(new Question("Which of the following statements about Java garbage collection is TRUE?",
                    new String[]{"It automatically frees memory by destroying unreachable objects", "It requires manual invocation to run", "It pauses all threads while running", "It only runs when the program exits"}, 0));
